...
export const TUNING_FIELDS: readonly TuningField[] = [
  ...
  {
    key: "S_COIN_LEVEL_CHANCE",
    section: "Coins",
    label: "Special coin: chance per level",
    default: 0.15,
    min: 0, max: 1, step: 0.01, liveReload: false,
    description: "Probability (0–1) that a Special coin appears at all during a level.",
  },
  {
    key: "S_COIN_SPAWN_MIN_DELAY_MS",
    section: "Coins",
    label: "Special coin: earliest spawn (ms)",
    default: 10_000,
    min: 0, max: 300_000, step: 500, liveReload: false,
    description: "Minimum time after level start before a Special coin can appear.",
  },
  {
    key: "S_COIN_SPAWN_MAX_DELAY_MS",
    section: "Coins",
    label: "Special coin: latest spawn (ms)",
    default: 90_000,
    min: 1_000, max: 600_000, step: 500, liveReload: false,
    description: "Maximum time after level start. Spawn time is random between earliest and latest.",
  },
