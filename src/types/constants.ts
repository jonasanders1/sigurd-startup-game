...
export const GAME_CONFIG = {
  ...
  // Entity sizes — bounds (physics envelope). Lethal hitbox lives separately
  // (see ENTITY_SIZES.PLAYER.hitbox / per-monster HITBOX in src/entities/).
  PLAYER_WIDTH: ENTITY_SIZES.PLAYER.bounds.width,
  PLAYER_HEIGHT: ENTITY_SIZES.PLAYER.bounds.height,
  FOUNDING_SIZE: ENTITY_SIZES.FOUNDING.width,
  COIN_SIZE: ENTITY_SIZES.COIN.width,
  ...
  // Game rules
  TOTAL_FOUNDINGS: GAME_RULES.TOTAL_FOUNDINGS,
  STARTING_LIVES: GAME_RULES.STARTING_LIVES,
  MAX_LIVES: GAME_RULES.MAX_LIVES,
